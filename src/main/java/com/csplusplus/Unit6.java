...
public static void main(String[] args) {
       ...
       System.out.println("Sum of array: " + sumArray(sampleArray));  
       System.out.println("Max element: " + maxElement(sampleArray));
       System.out.print("Reversed array: " +reverseArray(sampleArray));
       System.out.println("Is sorted: " + isSorted(sampleArray));
       System.out.println("Count occurrences of 3: " + countOccurrences(sampleArray, 3));
    }
}
